...
with urllib.request.urlopen('https://github.com/cinnavonn/training9/blob/main/gapminder_clean.csv') as response:
   html = response.read()
...
df = pd.read_csv('https://github.com/cinnavonn/training9/blob/main/gapminder_clean.csv', index_col=[0])
